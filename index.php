						...
						<form method="POST" class="ncform">
							<table class="nc_table">
								<tr>
									...
									<td>
										<?php
											select('marka','válassz','brand','',$_SESSION['nc']['marka'],1);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select('modell','válassz','modell',$_SESSION['nc']['marka'],$_SESSION['nc']['modell'],0);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											inputtext('typesign',$_SESSION['nc']['typesign']);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select('kivitel','válassz','kivitel','',$_SESSION['nc']['kivitel'],0);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select_nums('evjarat','válassz',date('Y'),1900,$_SESSION['nc']['evjarat']);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											inputtext('vetelar',$_SESSION['nc']['vetelar']);
										?>Huf
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											inputtext('kmora',$_SESSION['nc']['kmora']);
										?>Km
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select('fuel','válassz','fuel','',$_SESSION['nc']['fuel'],0);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select('condition','válassz','condtn','',$_SESSION['nc']['condition'],0);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select_nums('ajtok','válassz',0,5,$_SESSION['nc']['ajtok']);
										?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<?php
											select_nums('ulesek','válassz',0,9,$_SESSION['nc']['ulesek']);
										?>
									</td>
								</tr>
								<tr>
									...
									<td>
										<?php
											select('color','válassz','colors','',$_SESSION['nc']['color'],0);
										?>
									</td>
								</tr>
							</table>
